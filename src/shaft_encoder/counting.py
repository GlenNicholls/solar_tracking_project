...
GPIO.setup(A_az, GPIO.IN, pull_up_down=GPIO.PUD_UP)
GPIO.setup(B_az_az, GPIO.IN, pull_up_down=GPIO.PUD_UP)

GPIO.setup(A_el, GPIO.IN, pull_up_down=GPIO.PUD_UP)
GPIO.setup(B_el, GPIO.IN, pull_up_down=GPIO.PUD_UP)
